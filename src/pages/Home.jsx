...
const Home = () => {
  ...
  const fetchServices = async () => {
    try {
      const response = await fetch(import.meta.env.BASE_URL + 'service.json');
  ...
  return (
    <div className="container mx-auto px-4 py-8">
      ...
      {featuredServices.length > 0 && !searchQuery && selectedCategory === 'All' && (
        <div className="mb-12">
          <h2 className="text-3xl font-bold text-gray-800 dark:text-white mb-6">Featured Services</h2>
      ...
      <div className="mb-8">
        <div className="flex items-center gap-2 mb-4">
          ...
          <h3 className="text-xl font-semibold text-gray-800 dark:text-white">Filter by Category</h3>
        </div>
      ...
      <div className="mb-8">
        <h2 className="text-2xl font-bold text-gray-800 dark:text-white mb-6">
          ...
          <span className="text-gray-500 dark:text-gray-400 ml-2 text-lg">({filteredServices.length})</span>
        </h2>
